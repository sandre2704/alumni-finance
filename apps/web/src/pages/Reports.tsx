    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-display min-h-screen flex flex-col">
            ...
            <main className="flex-1 w-full py-8">
                <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 flex flex-col gap-8">
            ...
            {/* Footer */}
            <footer className="mt-auto border-t border-gray-200 dark:border-border-dark py-8 px-4 bg-white dark:bg-background-dark">
                <div className="mx-auto max-w-[1280px] flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-2 text-slate-500 dark:text-text-secondary">
                        <span className="text-sm">© 2023 Alumni Finance. Hak Cipta Dilindungi.</span>
                    </div>
                    <div className="flex gap-6">
                        <a className="text-sm text-slate-500 dark:text-text-secondary hover:text-primary dark:hover:text-white transition-colors" href="#">Bantuan</a>
                        <a className="text-sm text-slate-500 dark:text-text-secondary hover:text-primary dark:hover:text-white transition-colors" href="#">Kebijakan Privasi</a>
                        <a className="text-sm text-slate-500 dark:text-text-secondary hover:text-primary dark:hover:text-white transition-colors" href="#">Syarat &amp; Ketentuan</a>
                    </div>
                </div>
            </footer>
        </div>
