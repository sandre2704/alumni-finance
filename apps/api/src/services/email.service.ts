...
export const emailService = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="${url}" style="background-color: #2424eb; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold;">
                            Verifikasi Email
                        </a>
                    </div>
    ...
    async sendPasswordResetEmail(to: string, url: string, name: string) {
        if (!transporter) {
